...
Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/renyichun/YCCardView'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ryccccccccc' => '787725121@qq.com' }
  s.source           = { :git => 'https://github.com/renyichun/YCCardView.git', :tag => s.version.to_s }
